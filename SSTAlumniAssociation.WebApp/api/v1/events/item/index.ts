...
// @ts-ignore
import { createEmptyFromDiscriminatorValue, createEventFromDiscriminatorValue, createEventSimpleFromDiscriminatorValue, createStatusFromDiscriminatorValue, serializeEventSimple, serializeUpdateEventRequest, type Empty, type Event, type EventSimple, type Status, type UpdateEventRequest } from '../../../models/';
// @ts-ignore
import { AttendeesRequestBuilderRequestsMetadata, type AttendeesRequestBuilder } from './attendees/';
// @ts-ignore
import { AttendeesBatchAddRequestBuilderRequestsMetadata, type AttendeesBatchAddRequestBuilder } from './attendeesBatchAdd/';
// @ts-ignore
...
export interface EventsItemRequestBuilder extends BaseRequestBuilder<EventsItemRequestBuilder> {
     ...
     * @throws {Status} error when the service returns a 4XX or 5XX status code
     */
     patch(body: UpdateEventRequest, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<EventSimple | undefined>;
    /**
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
...
export const EventsItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    patch: {
        ...
        adapterMethodName: "send",
        responseBodyFactory:  createEventSimpleFromDiscriminatorValue,
