...
// @ts-ignore
import { createEventSimpleFromDiscriminatorValue, createListEventsResponseFromDiscriminatorValue, createStatusFromDiscriminatorValue, serializeEventSimple, type EventSimple, type ListEventsResponse, type Status } from '../../models/';
// @ts-ignore
import { EventsItemRequestBuilderNavigationMetadata, EventsItemRequestBuilderRequestsMetadata, type EventsItemRequestBuilder } from './item/';
// @ts-ignore
...
export interface EventsRequestBuilder extends BaseRequestBuilder<EventsRequestBuilder> {
     ...
     * @throws {Status} error when the service returns a 4XX or 5XX status code
     */
     post(body: EventSimple, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<EventSimple | undefined>;
    /**
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
...
export const EventsRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    post: {
        ...
        requestBodySerializer: serializeEventSimple,
