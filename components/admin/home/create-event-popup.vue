        ...
        <f7Page>
            ...
            <f7Page>
                <f7List form @submit.prevent="createEvent">
                    <f7ListInput v-model:value="event.id" label="Event ID" placeholder="A unique ID for this event" required/>
                    ...
                    <f7ListInput v-model:value="event.badgeImage" type="url" label="Image URL" placeholder="https://example.com" required/>
                    ...
                    <f7List inset>
                        <f7Button type="submit" preloader :loading="pending" :disabled="pending">
                            Done
                        </f7Button>
                    </f7List>
                </f7List>
