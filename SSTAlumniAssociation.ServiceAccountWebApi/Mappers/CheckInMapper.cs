...
public static partial class CheckInMapper
{
    ...
    public static partial Protos.CheckIn.V1.CheckIn ToGrpc(this IEnumerable<CheckIn> checkIn);
    ...
    public static partial GuestCheckIn ToGuestCheckIn(this Protos.CheckIn.V1.CheckIn checkIn);
    
    [MapperIgnoreSource(nameof(Protos.CheckIn.V1.CheckIn.User))]
    [MapProperty(nameof(Protos.CheckIn.V1.CheckIn.User), nameof(UserCheckIn.UserId))]
    public static partial UserCheckIn ToUserCheckIn(this Protos.CheckIn.V1.CheckIn checkIn);
